...
Bagaimana objek menyimpan data dan perilaku? Rahasianya terletak pada struktur **Property**. Di level spesifikasi, tidak ada perbedaan kasta antara data dan fungsi di dalam objek. (Clause 4.4.38 - 4.4.40).
...
## 3. Built-in Method (Clause 4.4.40)
