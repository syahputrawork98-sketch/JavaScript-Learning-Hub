...
## Kamus Mini Async
- Task queue (macrotask): antrean callback seperti `setTimeout`.
- Microtask queue: antrean prioritas tinggi untuk Promise jobs.
- Event loop: mekanisme pemilihan kerja berikutnya saat call stack kosong.
