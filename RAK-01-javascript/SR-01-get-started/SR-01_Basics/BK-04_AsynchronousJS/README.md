...
1. **[CH-01: Intro to Async](./CH-01_IntroToAsync/)**: Memahami masalah "Kemacetan" (Blocking code).
2. **[CH-02: Callbacks](./CH-02_Callbacks/)**: Protokol lama dalam menangani proses asinkron.
3. **[CH-03: Promises](./CH-03_Promises/)**: Konsep modern "Janji Energi" (Promises).
