...
## 🏗️ The 4 Pillars of Spec Rigor

```mermaid
graph TD
    P1["BK-01: Foundations (Clause 4.4)"] --> Core["Spec Literacy"]
    P2["BK-02: Notation (Clause 5)"] --> Core
    P3["BK-03: Logic (Clause 6.2)"] --> Core
    P4["BK-04: Semantics (Clause 5.1)"] --> Core
```

---

## Koleksi Buku:
1.  **[BK-01: Spec Foundations](./BK-01_SpecFoundations/)**: Terminologi dasar dan morfologi objek.
