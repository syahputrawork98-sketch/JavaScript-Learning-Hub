...
**Model Mental**:
- **BigInt**: Sebuah tangki bensin elastis. Ia bisa membesar seiring dengan bertambahnya volume data, tanpa pernah bocor (precision loss) seperti Number.
...
### Arsitek Mindset: Infinite Integrity
- Gunakan BigInt sebagai standar de-facto untuk semua ID numerik yang berasal dari sistem eksternal (seperti Twitter Snowflake ID). Jangan biarkan data Anda terkontaminasi oleh pembulatan otomatis tipe Number yang bisa merusak konsistensi data di Agent Hub.
