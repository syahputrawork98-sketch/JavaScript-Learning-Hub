...
**Model Mental**:
- **Symbol**: Sebuah ID Card biometrik yang unik secara global. Tidak ada dua kartu yang sama meskipun fotonya identik.
...
### Arsitek Mindset: Metadata Privacy
- Gunakan Symbol untuk properti "semi-private" yang tidak boleh muncul dalam iterasi normal (`Object.keys`). Ini melindungi sirkuit internal Anda dari manipulasi eksternal yang tidak sengaja namun tetap memberikan akses penuh bagi teknisi yang memegang kuncinya.
