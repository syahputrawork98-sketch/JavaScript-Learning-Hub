...
2. `../topics/02-language-types-values-dan-coercion.md`
3. `../topics/03-environment-record-scope-dan-closure.md`
4. `../topics/04-this-binding-call-dan-function-object.md`
5. `../topics/05-jobs-promise-dan-microtask.md`
6. `../topics/06-object-property-dan-prototype-internals.md`
7. `../topics/07-iteration-protocol-dan-async-function-flow.md`
8. `../topics/08-completion-record-dan-abrupt-completion.md`

## Strategi Membaca
- Mulai dari istilah dan tujuan section, bukan dari detail algoritme baris pertama.
