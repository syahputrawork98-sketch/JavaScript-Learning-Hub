...
## Kamus Mini Spec
- Normative text: kalimat aturan yang wajib diikuti implementasi.
- Informative note: catatan bantu pemahaman, bukan aturan inti.
- Abstract Operation: prosedur algoritmik formal di spec.
- Completion Record: model hasil evaluasi (normal/throw/return/break/continue).
